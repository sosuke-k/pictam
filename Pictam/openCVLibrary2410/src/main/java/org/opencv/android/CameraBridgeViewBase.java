...
//                }
                ...
                if (mWidthScale != 0 && mHeightScale != 0) {
                    canvas.drawBitmap(mCacheBitmap, new Rect(0, 0, mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
                            new Rect((int) ((canvas.getWidth() - mWidthScale * mCacheBitmap.getWidth()) / 2),
                                    (int) ((canvas.getHeight() - mHeightScale * mCacheBitmap.getHeight()) / 2),
                                    (int) ((canvas.getWidth() - mWidthScale * mCacheBitmap.getWidth()) / 2 + mWidthScale * mCacheBitmap.getWidth()),
                                    (int) ((canvas.getHeight() - mHeightScale * mCacheBitmap.getHeight()) / 2 + mHeightScale * mCacheBitmap.getHeight())), null);
                } else {
                    canvas.drawBitmap(mCacheBitmap, new Rect(0, 0, mCacheBitmap.getWidth(), mCacheBitmap.getHeight()),
                            new Rect((canvas.getWidth() - mCacheBitmap.getWidth()) / 2,
                                    (canvas.getHeight() - mCacheBitmap.getHeight()) / 2,
